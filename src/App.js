...
var markov = require('../node-markov-master');

var compliments = `You have very smooth hair
...
If you were in a chemistry class with me, it would be less boring
...
You're so cool, that on a scale of from 1-you're elevendyseven
...
I'd wake up for an 8 am class just so I could sit next to you
...
If I had a nickel for every time you did something stupid, I'd be broke!
...
class App extends Component {
  ...
  constructor(props) {
    super(props);
    this.generator = markov(1);
    this.state = {compliment: 'Wait for compliments'};
  }

  componentDidMount() {
    var self = this;
    this.generator.seed(compliments, function() {
      self.interval = setInterval(function() {
        self.setState(() => ({
          compliment: self.generator.respond('', 7).join(' ')
        }));
      }, 3000);
    });
  }
